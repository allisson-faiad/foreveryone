    ...
    <div id="conteudo">
        ...
        <div class="content">
            ...
            <div class="row align-items-center">
                ...
                <div class="col">
                    <h5> 17 anos, estou cursando Desenvolvimento de Sistemas na ETEC Dra. Ruth Cardoso. Busco para meu
                        futuro profissional fazer uma faculdade de Design Digital, Fotografia e de Administração. E para meu
            ...
            <div class="row align-items-center">
                <div class="col">
                    <h5 class="p1">Tenho 17 anos, estou cursando Desenvolvimento de Sistemas na ETEC Dra. Ruth Cardoso.
            ...
            <div class="row align-items-center">
                ...
                <div class="col">
                    <h5 class="p3">Tenho 17 anos, estou cursando Desenvolvimento de Sistemas na ETEC Dra. Ruth Cardoso.
                        Busco para meu futuro profissional fazer uma faculdade de Ciência da Computação e Engenharia de
                        Software.</h5>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col">
                    <h5 class="p1">Tenho 17 anos e no momento estou cursando Desenvolvimento de Sistemas na Etec Dra. Ruth Cardoso. Me vejo futuramente na área de pesquisas científica da tecnologia avançada existente.</h5>
                </div>
                <div class="col col-lg-3">
